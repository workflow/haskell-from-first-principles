...
fillInCharacter (Puzzle word filledInSoFar s incorrect) c = Puzzle word newFilledInSoFar (c : s) incorrect
...
handleGuess puzzle@(Puzzle word filledInSoFar s incorrect) guess = do
  ...
  case (charInWord puzzle guess, alreadyGuessed puzzle guess) of
    ...
    (False, _) -> do
      ...
      return (fillInCharacter (Puzzle word filledInSoFar s (incorrect + 1)) guess)
